    ...
    <section id="feature" class="container-fluid featured-section">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="featured-sections-items row">
            <div
              class="featured-section-item col-md-6"
  ...
  data() {
    return {
      ...
      featuredItems: [
        ...
        {
          image: 'slide5',
          title: 'Scott Launches NationWide Virtual Opportunity Zone Tour',
      ...
      newsItems: [
        ...
        {
          image: 'dark-side',
          title: 'OZs Could Be The Place -Based Solution We Need To Tackle USDA Food Deserts',
          src: 'Sorenson Impact Center',
          date: 'Oct 9, 2020',
        },
        {
          image: 'helping',
